...
def register_check(username):
    users = show_users()
    for user in users:
        if user[1] == sha256(username).hexdigest():
            return False
    return True
...
def login_check(username, password):
    users = show_users()
    for user in users:
        if user[1] == sha256(username).hexdigest() and user[2] == sha256(password).hexdigest():
            return True
    return False
...
def add_user(username, password, usermail):
    ...
    cursor.execute(query, (userid, sha256(username).hexdigest(), sha256(
        password).hexdigest(), sha256(usermail).hexdigest()))
    connection.commit()
    return True
...
def login():
    entered_username = (login_username_entry.get()).encode()
...
def register():
    entered_username = (register_username_entry.get()).encode()
    entered_password = (register_password_entry.get()).encode()
    entered_usermail = (register_usermail_entry.get()).encode()
...
screen = ctk.CTkFrame(root, height=500, width=500, background_corner_colors=[
                      "#E79215", "#E79215", "#E79215", "#E79215"], fg_color="#fc3c44", corner_radius=5)
screen.place(x=25, y=25)

login_frame = ctk.CTkFrame(root, height=500, width=500,
                           fg_color="#fc3c44", corner_radius=10)
register_frame = ctk.CTkFrame(
    root, height=500, width=500, fg_color="#fc3c44", corner_radius=5)

login_label = ctk.CTkLabel(login_frame, text="Login", text_color="white",
                           font=label_font, fg_color="black", corner_radius=5)

login_label.place(x=225, y=10)
login_username_label = ctk.CTkLabel(
    login_frame, text="Username:", text_color="white", font=my_font, fg_color="black", corner_radius=5)
...
login_password_label = ctk.CTkLabel(
    login_frame, text="Password:", text_color="white", font=my_font, fg_color="black", corner_radius=5)
...
login_button = ctk.CTkButton(login_frame, text="Login", command=login,
                             fg_color="black", font=my_font, text_color="white", corner_radius=5)

login_button.place(x=120, y=200)

register_button = ctk.CTkButton(login_frame, text="Register", command=show_register_page,
                                text_color="white", font=my_font, fg_color="black", corner_radius=5)

register_button.place(x=270, y=200)

register_label = ctk.CTkLabel(register_frame, text="Register",
                              text_color="white", font=my_font, fg_color="black", corner_radius=5)
register_label.place(x=225, y=10)
register_username_label = ctk.CTkLabel(
    register_frame, text="Username:", text_color="white", font=my_font, fg_color="black", corner_radius=5)
...
register_password_label = ctk.CTkLabel(
    register_frame, text="Password:", text_color="white", font=my_font, fg_color="black", corner_radius=5)
...
register_usermail_label = ctk.CTkLabel(
    register_frame, text="Mail:", text_color="white", font=my_font, fg_color="black", corner_radius=5)
...
back_button = ctk.CTkButton(register_frame, text="Back to Login", command=show_login_page,
                            text_color="white", font=my_font, fg_color="black", corner_radius=5)
