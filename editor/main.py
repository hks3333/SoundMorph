...
def about_us():
    ...
    lbl=ctk.CTkLabel(screen,text_color="white",font=my_font,text="Rahu H Nair -043").place(x=70,y=120)
    lbl_hk= ctk.CTkLabel(screen, text_color="white", font=my_font,
                       text='Harikrishnan S - 021').place(x=70, y=320)
    lbl_apn= ctk.CTkLabel(screen, text_color="white", font=my_font,
                       text="Adithyan Prateeksh - 008").place(x=840, y=120)
    lbl_nfs = ctk.CTkLabel(screen, text_color="white", font=my_font,
                       text="Naveed E Nissam - 038").place(x=840, y=320)
